document.addEventListener("DOMContentLoaded", function() {
    ...
    tStrs = getRandomSentences(tStrsRandom, 50);
    //console.log(tStrs);
    //console.log(tStrsRandom);
    ...
    function xCkStr() {
        ...
        if (t > topt) {
            ...
            let _t = Math.floor((100*t)/600);
            if (_t >= 100) _t = 100;
            dc.getElementById("id_g2").style.width = _t + '%';
        ...
        console.log("avp: " + avp);
        let _t = Math.floor((100*t)/600);
        let _avt = Math.floor((100*avt)/600);
        if (_t >= 100) _t = 100;
        if (_avt >= 100) _avt = 100;
        gId("id_g1").style.width = _t + '%';
        gId("id_g3").style.width = _avt + '%';
        gId("id_g4").style.width = Math.floor(p) + '%';
        gId("id_g5").style.width = Math.floor(avp) + '%';
